...
all: prerequisites.h instantiate_prerequisites.h friendDeclarationModifierTest
...
friendDeclarationModifierTest: friendDeclarationModifier.C friendDeclarationModifierMain.C libcompass.so $(COMPASS_PROJECT)/src/compassSupport/compassTestMain.C
	g++ -fPIC -Wall -o $@ friendDeclarationModifierMain.C friendDeclarationModifier.C -I$(COMPASS_PROJECT)/src/compassSupport -I$(ROSE_INSTALL)/include -I$(COMPASS_PROJECT)/extensions/prerequisites -I. $(LINKER_FLAGS)
