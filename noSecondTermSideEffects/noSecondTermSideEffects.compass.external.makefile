...
all: prerequisites.h instantiate_prerequisites.h noSecondTermSideEffectsTest
...
noSecondTermSideEffectsTest: noSecondTermSideEffects.C noSecondTermSideEffectsMain.C libcompass.so $(COMPASS_PROJECT)/src/compassSupport/compassTestMain.C
	g++ -fPIC -Wall -o $@ noSecondTermSideEffectsMain.C noSecondTermSideEffects.C -I$(COMPASS_PROJECT)/src/compassSupport -I$(ROSE_INSTALL)/include -I$(COMPASS_PROJECT)/extensions/prerequisites -I. $(LINKER_FLAGS)
