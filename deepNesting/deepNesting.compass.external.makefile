...
all: prerequisites.h instantiate_prerequisites.h deepNestingTest
...
deepNestingTest: deepNesting.C deepNestingMain.C libcompass.so $(COMPASS_PROJECT)/src/compassSupport/compassTestMain.C
	g++ -fPIC -Wall -o $@ deepNestingMain.C deepNesting.C -I$(COMPASS_PROJECT)/src/compassSupport -I$(ROSE_INSTALL)/include -I$(COMPASS_PROJECT)/extensions/prerequisites -I. $(LINKER_FLAGS)
