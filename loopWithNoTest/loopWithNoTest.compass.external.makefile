...
loopWithNoTestTest: loopWithNoTest.C loopWithNoTestMain.C libcompass.so $(COMPASS_PROJECT)/src/compassSupport/compassTestMain.C
	g++ -fPIC -Wall -o $@ loopWithNoTestMain.C loopWithNoTest.C -I$(COMPASS_PROJECT)/src/compassSupport -I$(ROSE_INSTALL)/include -I$(COMPASS_PROJECT)/extensions/prerequisites -I. $(LINKER_FLAGS)

test: loopWithNoTestTest loopWithNoTestTest1.C
	./loopWithNoTestTest loopWithNoTestTest1.C

clean:
	rm -f libcompass.so "loopWithNoTestTest"
