...
all: prerequisites.h instantiate_prerequisites.h protectVirtualMethodsTest
...
protectVirtualMethodsTest: protectVirtualMethods.C protectVirtualMethodsMain.C libcompass.so $(COMPASS_PROJECT)/src/compassSupport/compassTestMain.C
	g++ -fPIC -Wall -o $@ protectVirtualMethodsMain.C protectVirtualMethods.C -I$(COMPASS_PROJECT)/src/compassSupport -I$(ROSE_INSTALL)/include -I$(COMPASS_PROJECT)/extensions/prerequisites -I. $(LINKER_FLAGS)
