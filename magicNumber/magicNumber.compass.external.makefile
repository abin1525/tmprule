...
all: prerequisites.h instantiate_prerequisites.h magicNumberTest
...
magicNumberTest: magicNumber.C magicNumberMain.C libcompass.so $(COMPASS_PROJECT)/src/compassSupport/compassTestMain.C
	g++ -fPIC -Wall -o $@ magicNumberMain.C magicNumber.C -I$(COMPASS_PROJECT)/src/compassSupport -I$(ROSE_INSTALL)/include -I$(COMPASS_PROJECT)/extensions/prerequisites -I. $(LINKER_FLAGS)
