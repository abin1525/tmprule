...
all: prerequisites.h instantiate_prerequisites.h preferSetvbufToSetbufTest
...
preferSetvbufToSetbufTest: preferSetvbufToSetbuf.C preferSetvbufToSetbufMain.C libcompass.so $(COMPASS_PROJECT)/src/compassSupport/compassTestMain.C
	g++ -fPIC -Wall -o $@ preferSetvbufToSetbufMain.C preferSetvbufToSetbuf.C -I$(COMPASS_PROJECT)/src/compassSupport -I$(ROSE_INSTALL)/include -I$(COMPASS_PROJECT)/extensions/prerequisites -I. $(LINKER_FLAGS)
