...
freeNullTest: freeNull.C freeNullMain.C libcompass.so $(COMPASS_PROJECT)/src/compassSupport/compassTestMain.C
	g++ -fPIC -Wall -o $@ freeNullMain.C freeNull.C -I$(COMPASS_PROJECT)/src/compassSupport -I$(ROSE_INSTALL)/include -I$(COMPASS_PROJECT)/extensions/prerequisites -I. $(LINKER_FLAGS)

test: freeNullTest freeNullTest1.C
	./freeNullTest freeNullTest1.C

clean:
	rm -f libcompass.so "freeNullTest"
