...
all: prerequisites.h instantiate_prerequisites.h defaultConstructorTest
...
defaultConstructorTest: defaultConstructor.C defaultConstructorMain.C libcompass.so $(COMPASS_PROJECT)/src/compassSupport/compassTestMain.C
	g++ -fPIC -Wall -o $@ defaultConstructorMain.C defaultConstructor.C -I$(COMPASS_PROJECT)/src/compassSupport -I$(ROSE_INSTALL)/include -I$(COMPASS_PROJECT)/extensions/prerequisites -I. $(LINKER_FLAGS)
