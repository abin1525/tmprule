...
bufferOverflowTest: bufferOverflow.C bufferOverflowMain.C libcompass.so $(COMPASS_PROJECT)/src/compassSupport/compassTestMain.C
	g++ -fPIC -Wall -o $@ bufferOverflowMain.C bufferOverflow.C -I$(COMPASS_PROJECT)/src/compassSupport -I$(ROSE_INSTALL)/include -I$(COMPASS_PROJECT)/extensions/prerequisites -I. $(LINKER_FLAGS)

test: bufferOverflowTest bufferOverflowTest1.C
	./bufferOverflowTest bufferOverflowTest1.C

clean:
	rm -f libcompass.so "bufferOverflowTest"
