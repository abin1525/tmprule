...
divideByZeroTest: divideByZero.C divideByZeroMain.C libcompass.so $(COMPASS_PROJECT)/src/compassSupport/compassTestMain.C
	g++ -fPIC -Wall -o $@ divideByZeroMain.C divideByZero.C -I$(COMPASS_PROJECT)/src/compassSupport -I$(ROSE_INSTALL)/include -I$(COMPASS_PROJECT)/extensions/prerequisites -I. $(LINKER_FLAGS)

test: divideByZeroTest divideByZeroTest1.C
	./divideByZeroTest divideByZeroTest1.C

clean:
	rm -f libcompass.so "divideByZeroTest"
