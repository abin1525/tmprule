...
all: prerequisites.h instantiate_prerequisites.h singleParameterConstructorExplicitModifierTest
...
singleParameterConstructorExplicitModifierTest: singleParameterConstructorExplicitModifier.C singleParameterConstructorExplicitModifierMain.C libcompass.so $(COMPASS_PROJECT)/src/compassSupport/compassTestMain.C
	g++ -fPIC -Wall -o $@ singleParameterConstructorExplicitModifierMain.C singleParameterConstructorExplicitModifier.C -I$(COMPASS_PROJECT)/src/compassSupport -I$(ROSE_INSTALL)/include -I$(COMPASS_PROJECT)/extensions/prerequisites -I. $(LINKER_FLAGS)
