...
all: prerequisites.h instantiate_prerequisites.h operatorOverloadingTest
...
operatorOverloadingTest: operatorOverloading.C operatorOverloadingMain.C libcompass.so $(COMPASS_PROJECT)/src/compassSupport/compassTestMain.C
	g++ -fPIC -Wall -o $@ operatorOverloadingMain.C operatorOverloading.C -I$(COMPASS_PROJECT)/src/compassSupport -I$(ROSE_INSTALL)/include -I$(COMPASS_PROJECT)/extensions/prerequisites -I. $(LINKER_FLAGS)
