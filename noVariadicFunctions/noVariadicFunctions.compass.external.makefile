...
all: prerequisites.h instantiate_prerequisites.h noVariadicFunctionsTest
...
noVariadicFunctionsTest: noVariadicFunctions.C noVariadicFunctionsMain.C libcompass.so $(COMPASS_PROJECT)/src/compassSupport/compassTestMain.C
	g++ -fPIC -Wall -o $@ noVariadicFunctionsMain.C noVariadicFunctions.C -I$(COMPASS_PROJECT)/src/compassSupport -I$(ROSE_INSTALL)/include -I$(COMPASS_PROJECT)/extensions/prerequisites -I. $(LINKER_FLAGS)
