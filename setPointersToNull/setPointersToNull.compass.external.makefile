...
all: prerequisites.h instantiate_prerequisites.h setPointersToNullTest
...
setPointersToNullTest: setPointersToNull.C setPointersToNullMain.C libcompass.so $(COMPASS_PROJECT)/src/compassSupport/compassTestMain.C
	g++ -fPIC -Wall -o $@ setPointersToNullMain.C setPointersToNull.C -I$(COMPASS_PROJECT)/src/compassSupport -I$(ROSE_INSTALL)/include -I$(COMPASS_PROJECT)/extensions/prerequisites -I. $(LINKER_FLAGS)
