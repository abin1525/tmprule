...
all: prerequisites.h instantiate_prerequisites.h asynchronousSignalHandlerTest
...
asynchronousSignalHandlerTest: asynchronousSignalHandler.C asynchronousSignalHandlerMain.C libcompass.so $(COMPASS_PROJECT)/src/compassSupport/compassTestMain.C
	g++ -fPIC -Wall -o $@ asynchronousSignalHandlerMain.C asynchronousSignalHandler.C -I$(COMPASS_PROJECT)/src/compassSupport -I$(ROSE_INSTALL)/include -I$(COMPASS_PROJECT)/extensions/prerequisites -I. $(LINKER_FLAGS)
