...
all: prerequisites.h instantiate_prerequisites.h internalDataSharingTest
...
internalDataSharingTest: internalDataSharing.C internalDataSharingMain.C libcompass.so $(COMPASS_PROJECT)/src/compassSupport/compassTestMain.C
	g++ -fPIC -Wall -o $@ internalDataSharingMain.C internalDataSharing.C -I$(COMPASS_PROJECT)/src/compassSupport -I$(ROSE_INSTALL)/include -I$(COMPASS_PROJECT)/extensions/prerequisites -I. $(LINKER_FLAGS)
