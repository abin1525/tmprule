...
all: prerequisites.h instantiate_prerequisites.h nonStandardTypeRefArgsTest
...
nonStandardTypeRefArgsTest: nonStandardTypeRefArgs.C nonStandardTypeRefArgsMain.C libcompass.so $(COMPASS_PROJECT)/src/compassSupport/compassTestMain.C
	g++ -fPIC -Wall -o $@ nonStandardTypeRefArgsMain.C nonStandardTypeRefArgs.C -I$(COMPASS_PROJECT)/src/compassSupport -I$(ROSE_INSTALL)/include -I$(COMPASS_PROJECT)/extensions/prerequisites -I. $(LINKER_FLAGS)
