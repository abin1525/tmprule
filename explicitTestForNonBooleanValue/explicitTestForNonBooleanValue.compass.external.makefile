...
all: prerequisites.h instantiate_prerequisites.h explicitTestForNonBooleanValueTest
...
explicitTestForNonBooleanValueTest: explicitTestForNonBooleanValue.C explicitTestForNonBooleanValueMain.C libcompass.so $(COMPASS_PROJECT)/src/compassSupport/compassTestMain.C
	g++ -fPIC -Wall -o $@ explicitTestForNonBooleanValueMain.C explicitTestForNonBooleanValue.C -I$(COMPASS_PROJECT)/src/compassSupport -I$(ROSE_INSTALL)/include -I$(COMPASS_PROJECT)/extensions/prerequisites -I. $(LINKER_FLAGS)
