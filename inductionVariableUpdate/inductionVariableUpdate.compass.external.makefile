...
all: prerequisites.h instantiate_prerequisites.h inductionVariableUpdateTest
...
inductionVariableUpdateTest: inductionVariableUpdate.C inductionVariableUpdateMain.C libcompass.so $(COMPASS_PROJECT)/src/compassSupport/compassTestMain.C
	g++ -fPIC -Wall -o $@ inductionVariableUpdateMain.C inductionVariableUpdate.C -I$(COMPASS_PROJECT)/src/compassSupport -I$(ROSE_INSTALL)/include -I$(COMPASS_PROJECT)/extensions/prerequisites -I. $(LINKER_FLAGS)
