...
all: prerequisites.h instantiate_prerequisites.h explicitCopyTest
...
explicitCopyTest: explicitCopy.C explicitCopyMain.C libcompass.so $(COMPASS_PROJECT)/src/compassSupport/compassTestMain.C
	g++ -fPIC -Wall -o $@ explicitCopyMain.C explicitCopy.C -I$(COMPASS_PROJECT)/src/compassSupport -I$(ROSE_INSTALL)/include -I$(COMPASS_PROJECT)/extensions/prerequisites -I. $(LINKER_FLAGS)
