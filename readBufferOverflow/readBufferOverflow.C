...
CompassAnalyses::ReadBufferOverflow::
CheckerOutput::CheckerOutput ( SgNode* node )
   : OutputViolationBase(node,::readBufferOverflowChecker->checkerName,::readBufferOverflowChecker->shortDescription)
   {}

CompassAnalyses::ReadBufferOverflow::Traversal::
Traversal(Compass::Parameters inputParameters, Compass::OutputObject* output)
   : output(output)
   {
  // Initalize checker specific parameters here, for example: 
  // YourParameter = Compass::parseInteger(inputParameters["ReadBufferOverflow.YourParameter"]);
...
static void run(Compass::Parameters params, Compass::OutputObject* output) {
  CompassAnalyses::ReadBufferOverflow::Traversal(params, output).run(Compass::projectPrerequisite.getProject());
}
