...
all: prerequisites.h instantiate_prerequisites.h cycleDetectionTest
...
cycleDetectionTest: cycleDetection.C cycleDetectionMain.C libcompass.so $(COMPASS_PROJECT)/src/compassSupport/compassTestMain.C
	g++ -fPIC -Wall -o $@ cycleDetectionMain.C cycleDetection.C -I$(COMPASS_PROJECT)/src/compassSupport -I$(ROSE_INSTALL)/include -I$(COMPASS_PROJECT)/extensions/prerequisites -I. $(LINKER_FLAGS)
