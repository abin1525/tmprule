...
all: prerequisites.h instantiate_prerequisites.h doNotDeleteThisTest
...
doNotDeleteThisTest: doNotDeleteThis.C doNotDeleteThisMain.C libcompass.so $(COMPASS_PROJECT)/src/compassSupport/compassTestMain.C
	g++ -fPIC -Wall -o $@ doNotDeleteThisMain.C doNotDeleteThis.C -I$(COMPASS_PROJECT)/src/compassSupport -I$(ROSE_INSTALL)/include -I$(COMPASS_PROJECT)/extensions/prerequisites -I. $(LINKER_FLAGS)
