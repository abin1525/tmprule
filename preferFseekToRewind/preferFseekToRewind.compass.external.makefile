...
all: prerequisites.h instantiate_prerequisites.h preferFseekToRewindTest
...
preferFseekToRewindTest: preferFseekToRewind.C preferFseekToRewindMain.C libcompass.so $(COMPASS_PROJECT)/src/compassSupport/compassTestMain.C
	g++ -fPIC -Wall -o $@ preferFseekToRewindMain.C preferFseekToRewind.C -I$(COMPASS_PROJECT)/src/compassSupport -I$(ROSE_INSTALL)/include -I$(COMPASS_PROJECT)/extensions/prerequisites -I. $(LINKER_FLAGS)
