...
all: prerequisites.h instantiate_prerequisites.h cppCallsSetjmpLongjmpTest
...
cppCallsSetjmpLongjmpTest: cppCallsSetjmpLongjmp.C cppCallsSetjmpLongjmpMain.C libcompass.so $(COMPASS_PROJECT)/src/compassSupport/compassTestMain.C
	g++ -fPIC -Wall -o $@ cppCallsSetjmpLongjmpMain.C cppCallsSetjmpLongjmp.C -I$(COMPASS_PROJECT)/src/compassSupport -I$(ROSE_INSTALL)/include -I$(COMPASS_PROJECT)/extensions/prerequisites -I. $(LINKER_FLAGS)
