...
all: prerequisites.h instantiate_prerequisites.h time_tDirectManipulationTest
...
time_tDirectManipulationTest: time_tDirectManipulation.C time_tDirectManipulationMain.C libcompass.so $(COMPASS_PROJECT)/src/compassSupport/compassTestMain.C
	g++ -fPIC -Wall -o $@ time_tDirectManipulationMain.C time_tDirectManipulation.C -I$(COMPASS_PROJECT)/src/compassSupport -I$(ROSE_INSTALL)/include -I$(COMPASS_PROJECT)/extensions/prerequisites -I. $(LINKER_FLAGS)
