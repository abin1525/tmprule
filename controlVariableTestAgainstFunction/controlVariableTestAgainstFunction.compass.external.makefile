...
all: prerequisites.h instantiate_prerequisites.h controlVariableTestAgainstFunctionTest
...
controlVariableTestAgainstFunctionTest: controlVariableTestAgainstFunction.C controlVariableTestAgainstFunctionMain.C libcompass.so $(COMPASS_PROJECT)/src/compassSupport/compassTestMain.C
	g++ -fPIC -Wall -o $@ controlVariableTestAgainstFunctionMain.C controlVariableTestAgainstFunction.C -I$(COMPASS_PROJECT)/src/compassSupport -I$(ROSE_INSTALL)/include -I$(COMPASS_PROJECT)/extensions/prerequisites -I. $(LINKER_FLAGS)
