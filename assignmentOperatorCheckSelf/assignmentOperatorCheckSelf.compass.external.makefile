...
all: prerequisites.h instantiate_prerequisites.h assignmentOperatorCheckSelfTest
...
assignmentOperatorCheckSelfTest: assignmentOperatorCheckSelf.C assignmentOperatorCheckSelfMain.C libcompass.so $(COMPASS_PROJECT)/src/compassSupport/compassTestMain.C
	g++ -fPIC -Wall -o $@ assignmentOperatorCheckSelfMain.C assignmentOperatorCheckSelf.C -I$(COMPASS_PROJECT)/src/compassSupport -I$(ROSE_INSTALL)/include -I$(COMPASS_PROJECT)/extensions/prerequisites -I. $(LINKER_FLAGS)
