...
all: prerequisites.h instantiate_prerequisites.h assignmentReturnConstThisTest
...
assignmentReturnConstThisTest: assignmentReturnConstThis.C assignmentReturnConstThisMain.C libcompass.so $(COMPASS_PROJECT)/src/compassSupport/compassTestMain.C
	g++ -fPIC -Wall -o $@ assignmentReturnConstThisMain.C assignmentReturnConstThis.C -I$(COMPASS_PROJECT)/src/compassSupport -I$(ROSE_INSTALL)/include -I$(COMPASS_PROJECT)/extensions/prerequisites -I. $(LINKER_FLAGS)
