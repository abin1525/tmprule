...
emptyStatmentTest: emptyStatment.C emptyStatmentMain.C libcompass.so $(COMPASS_PROJECT)/src/compassSupport/compassTestMain.C
	g++ -fPIC -Wall -o $@ emptyStatmentMain.C emptyStatment.C -I$(COMPASS_PROJECT)/src/compassSupport -I$(ROSE_INSTALL)/include -I$(COMPASS_PROJECT)/extensions/prerequisites -I. $(LINKER_FLAGS)

test: emptyStatmentTest emptyStatmentTest1.C
	./emptyStatmentTest emptyStatmentTest1.C

clean:
	rm -f libcompass.so "emptyStatmentTest"
