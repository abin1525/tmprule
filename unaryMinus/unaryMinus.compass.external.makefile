...
all: prerequisites.h instantiate_prerequisites.h unaryMinusTest
...
unaryMinusTest: unaryMinus.C unaryMinusMain.C libcompass.so $(COMPASS_PROJECT)/src/compassSupport/compassTestMain.C
	g++ -fPIC -Wall -o $@ unaryMinusMain.C unaryMinus.C -I$(COMPASS_PROJECT)/src/compassSupport -I$(ROSE_INSTALL)/include -I$(COMPASS_PROJECT)/extensions/prerequisites -I. $(LINKER_FLAGS)
