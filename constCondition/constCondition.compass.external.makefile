...
constConditionTest: constCondition.C constConditionMain.C libcompass.so $(COMPASS_PROJECT)/src/compassSupport/compassTestMain.C
	g++ -fPIC -Wall -o $@ constConditionMain.C constCondition.C -I$(COMPASS_PROJECT)/src/compassSupport -I$(ROSE_INSTALL)/include -I$(COMPASS_PROJECT)/extensions/prerequisites -I. $(LINKER_FLAGS)

test: constConditionTest constConditionTest1.C
	./constConditionTest constConditionTest1.C

clean:
	rm -f libcompass.so "constConditionTest"
