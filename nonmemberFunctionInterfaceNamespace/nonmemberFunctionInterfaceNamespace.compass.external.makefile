...
all: prerequisites.h instantiate_prerequisites.h nonmemberFunctionInterfaceNamespaceTest
...
nonmemberFunctionInterfaceNamespaceTest: nonmemberFunctionInterfaceNamespace.C nonmemberFunctionInterfaceNamespaceMain.C libcompass.so $(COMPASS_PROJECT)/src/compassSupport/compassTestMain.C
	g++ -fPIC -Wall -o $@ nonmemberFunctionInterfaceNamespaceMain.C nonmemberFunctionInterfaceNamespace.C -I$(COMPASS_PROJECT)/src/compassSupport -I$(ROSE_INSTALL)/include -I$(COMPASS_PROJECT)/extensions/prerequisites -I. $(LINKER_FLAGS)
