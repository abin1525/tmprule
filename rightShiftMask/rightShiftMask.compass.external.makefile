...
all: prerequisites.h instantiate_prerequisites.h rightShiftMaskTest
...
rightShiftMaskTest: rightShiftMask.C rightShiftMaskMain.C libcompass.so $(COMPASS_PROJECT)/src/compassSupport/compassTestMain.C
	g++ -fPIC -Wall -o $@ rightShiftMaskMain.C rightShiftMask.C -I$(COMPASS_PROJECT)/src/compassSupport -I$(ROSE_INSTALL)/include -I$(COMPASS_PROJECT)/extensions/prerequisites -I. $(LINKER_FLAGS)
