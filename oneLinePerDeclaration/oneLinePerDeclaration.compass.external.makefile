...
all: prerequisites.h instantiate_prerequisites.h oneLinePerDeclarationTest
...
oneLinePerDeclarationTest: oneLinePerDeclaration.C oneLinePerDeclarationMain.C libcompass.so $(COMPASS_PROJECT)/src/compassSupport/compassTestMain.C
	g++ -fPIC -Wall -o $@ oneLinePerDeclarationMain.C oneLinePerDeclaration.C -I$(COMPASS_PROJECT)/src/compassSupport -I$(ROSE_INSTALL)/include -I$(COMPASS_PROJECT)/extensions/prerequisites -I. $(LINKER_FLAGS)
