...
all: prerequisites.h instantiate_prerequisites.h cyclomaticComplexityTest
...
cyclomaticComplexityTest: cyclomaticComplexity.C cyclomaticComplexityMain.C libcompass.so $(COMPASS_PROJECT)/src/compassSupport/compassTestMain.C
	g++ -fPIC -Wall -o $@ cyclomaticComplexityMain.C cyclomaticComplexity.C -I$(COMPASS_PROJECT)/src/compassSupport -I$(ROSE_INSTALL)/include -I$(COMPASS_PROJECT)/extensions/prerequisites -I. $(LINKER_FLAGS)
