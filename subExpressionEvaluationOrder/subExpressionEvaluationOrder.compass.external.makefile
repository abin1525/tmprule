...
all: prerequisites.h instantiate_prerequisites.h subExpressionEvaluationOrderTest
...
subExpressionEvaluationOrderTest: subExpressionEvaluationOrder.C subExpressionEvaluationOrderMain.C libcompass.so $(COMPASS_PROJECT)/src/compassSupport/compassTestMain.C
	g++ -fPIC -Wall -o $@ subExpressionEvaluationOrderMain.C subExpressionEvaluationOrder.C -I$(COMPASS_PROJECT)/src/compassSupport -I$(ROSE_INSTALL)/include -I$(COMPASS_PROJECT)/extensions/prerequisites -I. $(LINKER_FLAGS)
