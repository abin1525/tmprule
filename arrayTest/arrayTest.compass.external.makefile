...
arrayTest: allowedFunctions.C allowedFunctionsMain.C libcompass.so $(COMPASS_PROJECT)/src/compassSupport/compassTestMain.C
	g++ -fPIC -Wall -o $@ allowedFunctionsMain.C allowedFunctions.C -I$(COMPASS_PROJECT)/src/compassSupport -I$(ROSE_INSTALL)/include -I$(COMPASS_PROJECT)/extensions/prerequisites -I. $(LINKER_FLAGS)

test: arrayTest allowedFunctionsTest1.C
	./arrayTest allowedFunctionsTest1.C

clean:
	rm -f libcompass.so "arrayTest"
