...
all: prerequisites.h instantiate_prerequisites.h forbiddenFunctionsTest
...
forbiddenFunctionsTest: forbiddenFunctions.C forbiddenFunctionsMain.C libcompass.so $(COMPASS_PROJECT)/src/compassSupport/compassTestMain.C
	g++ -fPIC -Wall -o $@ forbiddenFunctionsMain.C forbiddenFunctions.C -I$(COMPASS_PROJECT)/src/compassSupport -I$(ROSE_INSTALL)/include -I$(COMPASS_PROJECT)/extensions/prerequisites -I. $(LINKER_FLAGS)
