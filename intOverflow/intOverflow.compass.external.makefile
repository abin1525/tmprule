...
intOverflowTest: intOverflow.C intOverflowMain.C libcompass.so $(COMPASS_PROJECT)/src/compassSupport/compassTestMain.C
	g++ -fPIC -Wall -o $@ intOverflowMain.C intOverflow.C -I$(COMPASS_PROJECT)/src/compassSupport -I$(ROSE_INSTALL)/include -I$(COMPASS_PROJECT)/extensions/prerequisites -I. $(LINKER_FLAGS)

test: intOverflowTest intOverflowTest1.C
	./intOverflowTest intOverflowTest1.C

clean:
	rm -f libcompass.so "intOverflowTest"
