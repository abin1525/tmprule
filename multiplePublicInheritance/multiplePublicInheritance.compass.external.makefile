...
all: prerequisites.h instantiate_prerequisites.h multiplePublicInheritanceTest
...
multiplePublicInheritanceTest: multiplePublicInheritance.C multiplePublicInheritanceMain.C libcompass.so $(COMPASS_PROJECT)/src/compassSupport/compassTestMain.C
	g++ -fPIC -Wall -o $@ multiplePublicInheritanceMain.C multiplePublicInheritance.C -I$(COMPASS_PROJECT)/src/compassSupport -I$(ROSE_INSTALL)/include -I$(COMPASS_PROJECT)/extensions/prerequisites -I. $(LINKER_FLAGS)
