...
all: prerequisites.h instantiate_prerequisites.h ternaryOperatorTest
...
ternaryOperatorTest: ternaryOperator.C ternaryOperatorMain.C libcompass.so $(COMPASS_PROJECT)/src/compassSupport/compassTestMain.C
	g++ -fPIC -Wall -o $@ ternaryOperatorMain.C ternaryOperator.C -I$(COMPASS_PROJECT)/src/compassSupport -I$(ROSE_INSTALL)/include -I$(COMPASS_PROJECT)/extensions/prerequisites -I. $(LINKER_FLAGS)
