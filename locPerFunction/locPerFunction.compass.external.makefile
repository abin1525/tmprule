...
all: prerequisites.h instantiate_prerequisites.h locPerFunctionTest
...
locPerFunctionTest: locPerFunction.C locPerFunctionMain.C libcompass.so $(COMPASS_PROJECT)/src/compassSupport/compassTestMain.C
	g++ -fPIC -Wall -o $@ locPerFunctionMain.C locPerFunction.C -I$(COMPASS_PROJECT)/src/compassSupport -I$(ROSE_INSTALL)/include -I$(COMPASS_PROJECT)/extensions/prerequisites -I. $(LINKER_FLAGS)
