...
all: prerequisites.h instantiate_prerequisites.h booleanIsHasTest
...
booleanIsHasTest: booleanIsHas.C booleanIsHasMain.C libcompass.so $(COMPASS_PROJECT)/src/compassSupport/compassTestMain.C
	g++ -fPIC -Wall -o $@ booleanIsHasMain.C booleanIsHas.C -I$(COMPASS_PROJECT)/src/compassSupport -I$(ROSE_INSTALL)/include -I$(COMPASS_PROJECT)/extensions/prerequisites -I. $(LINKER_FLAGS)
