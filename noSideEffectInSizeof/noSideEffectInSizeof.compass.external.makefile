...
all: prerequisites.h instantiate_prerequisites.h noSideEffectInSizeofTest
...
noSideEffectInSizeofTest: noSideEffectInSizeof.C noSideEffectInSizeofMain.C libcompass.so $(COMPASS_PROJECT)/src/compassSupport/compassTestMain.C
	g++ -fPIC -Wall -o $@ noSideEffectInSizeofMain.C noSideEffectInSizeof.C -I$(COMPASS_PROJECT)/src/compassSupport -I$(ROSE_INSTALL)/include -I$(COMPASS_PROJECT)/extensions/prerequisites -I. $(LINKER_FLAGS)
