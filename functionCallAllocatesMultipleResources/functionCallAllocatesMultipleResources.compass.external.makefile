...
all: prerequisites.h instantiate_prerequisites.h functionCallAllocatesMultipleResourcesTest
...
functionCallAllocatesMultipleResourcesTest: functionCallAllocatesMultipleResources.C functionCallAllocatesMultipleResourcesMain.C libcompass.so $(COMPASS_PROJECT)/src/compassSupport/compassTestMain.C
	g++ -fPIC -Wall -o $@ functionCallAllocatesMultipleResourcesMain.C functionCallAllocatesMultipleResources.C -I$(COMPASS_PROJECT)/src/compassSupport -I$(ROSE_INSTALL)/include -I$(COMPASS_PROJECT)/extensions/prerequisites -I. $(LINKER_FLAGS)
