...
all: prerequisites.h instantiate_prerequisites.h constructorDestructorCallsVirtualFunctionTest
...
constructorDestructorCallsVirtualFunctionTest: constructorDestructorCallsVirtualFunction.C constructorDestructorCallsVirtualFunctionMain.C libcompass.so $(COMPASS_PROJECT)/src/compassSupport/compassTestMain.C
	g++ -fPIC -Wall -o $@ constructorDestructorCallsVirtualFunctionMain.C constructorDestructorCallsVirtualFunction.C -I$(COMPASS_PROJECT)/src/compassSupport -I$(ROSE_INSTALL)/include -I$(COMPASS_PROJECT)/extensions/prerequisites -I. $(LINKER_FLAGS)
