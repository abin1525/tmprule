...
all: prerequisites.h instantiate_prerequisites.h stringTokenToIntegerConverterTest
...
stringTokenToIntegerConverterTest: stringTokenToIntegerConverter.C stringTokenToIntegerConverterMain.C libcompass.so $(COMPASS_PROJECT)/src/compassSupport/compassTestMain.C
	g++ -fPIC -Wall -o $@ stringTokenToIntegerConverterMain.C stringTokenToIntegerConverter.C -I$(COMPASS_PROJECT)/src/compassSupport -I$(ROSE_INSTALL)/include -I$(COMPASS_PROJECT)/extensions/prerequisites -I. $(LINKER_FLAGS)
