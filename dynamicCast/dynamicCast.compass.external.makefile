...
all: prerequisites.h instantiate_prerequisites.h dynamicCastTest
...
dynamicCastTest: dynamicCast.C dynamicCastMain.C libcompass.so $(COMPASS_PROJECT)/src/compassSupport/compassTestMain.C
	g++ -fPIC -Wall -o $@ dynamicCastMain.C dynamicCast.C -I$(COMPASS_PROJECT)/src/compassSupport -I$(ROSE_INSTALL)/include -I$(COMPASS_PROJECT)/extensions/prerequisites -I. $(LINKER_FLAGS)
