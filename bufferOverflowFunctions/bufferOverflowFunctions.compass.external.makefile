...
all: prerequisites.h instantiate_prerequisites.h bufferOverflowFunctionsTest
...
bufferOverflowFunctionsTest: bufferOverflowFunctions.C bufferOverflowFunctionsMain.C libcompass.so $(COMPASS_PROJECT)/src/compassSupport/compassTestMain.C
	g++ -fPIC -Wall -o $@ bufferOverflowFunctionsMain.C bufferOverflowFunctions.C -I$(COMPASS_PROJECT)/src/compassSupport -I$(ROSE_INSTALL)/include -I$(COMPASS_PROJECT)/extensions/prerequisites -I. $(LINKER_FLAGS)
