...
all: prerequisites.h instantiate_prerequisites.h duffsDeviceTest
...
duffsDeviceTest: duffsDevice.C duffsDeviceMain.C libcompass.so $(COMPASS_PROJECT)/src/compassSupport/compassTestMain.C
	g++ -fPIC -Wall -o $@ duffsDeviceMain.C duffsDevice.C -I$(COMPASS_PROJECT)/src/compassSupport -I$(ROSE_INSTALL)/include -I$(COMPASS_PROJECT)/extensions/prerequisites -I. $(LINKER_FLAGS)
