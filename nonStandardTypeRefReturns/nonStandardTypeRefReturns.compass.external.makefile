...
all: prerequisites.h instantiate_prerequisites.h nonStandardTypeRefReturnsTest
...
nonStandardTypeRefReturnsTest: nonStandardTypeRefReturns.C nonStandardTypeRefReturnsMain.C libcompass.so $(COMPASS_PROJECT)/src/compassSupport/compassTestMain.C
	g++ -fPIC -Wall -o $@ nonStandardTypeRefReturnsMain.C nonStandardTypeRefReturns.C -I$(COMPASS_PROJECT)/src/compassSupport -I$(ROSE_INSTALL)/include -I$(COMPASS_PROJECT)/extensions/prerequisites -I. $(LINKER_FLAGS)
