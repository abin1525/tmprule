...
all: prerequisites.h instantiate_prerequisites.h preferAlgorithmsTest
...
preferAlgorithmsTest: preferAlgorithms.C preferAlgorithmsMain.C libcompass.so $(COMPASS_PROJECT)/src/compassSupport/compassTestMain.C
	g++ -fPIC -Wall -o $@ preferAlgorithmsMain.C preferAlgorithms.C -I$(COMPASS_PROJECT)/src/compassSupport -I$(ROSE_INSTALL)/include -I$(COMPASS_PROJECT)/extensions/prerequisites -I. $(LINKER_FLAGS)
