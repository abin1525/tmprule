...
all: prerequisites.h instantiate_prerequisites.h lowerRangeLimitTest
...
lowerRangeLimitTest: lowerRangeLimit.C lowerRangeLimitMain.C libcompass.so $(COMPASS_PROJECT)/src/compassSupport/compassTestMain.C
	g++ -fPIC -Wall -o $@ lowerRangeLimitMain.C lowerRangeLimit.C -I$(COMPASS_PROJECT)/src/compassSupport -I$(ROSE_INSTALL)/include -I$(COMPASS_PROJECT)/extensions/prerequisites -I. $(LINKER_FLAGS)
