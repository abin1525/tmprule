...
all: prerequisites.h instantiate_prerequisites.h noOverloadAmpersandTest
...
noOverloadAmpersandTest: noOverloadAmpersand.C noOverloadAmpersandMain.C libcompass.so $(COMPASS_PROJECT)/src/compassSupport/compassTestMain.C
	g++ -fPIC -Wall -o $@ noOverloadAmpersandMain.C noOverloadAmpersand.C -I$(COMPASS_PROJECT)/src/compassSupport -I$(ROSE_INSTALL)/include -I$(COMPASS_PROJECT)/extensions/prerequisites -I. $(LINKER_FLAGS)
