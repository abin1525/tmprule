...
all: prerequisites.h instantiate_prerequisites.h nullDerefTest
...
nullDerefTest: nullDeref.C nullDerefMain.C libcompass.so $(COMPASS_PROJECT)/src/compassSupport/compassTestMain.C
	g++ -fPIC -Wall -o $@ nullDerefMain.C nullDeref.C -I$(COMPASS_PROJECT)/src/compassSupport -I$(ROSE_INSTALL)/include -I$(COMPASS_PROJECT)/extensions/prerequisites -I. $(LINKER_FLAGS)
