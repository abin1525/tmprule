...
all: prerequisites.h instantiate_prerequisites.h noAsmStmtsOpsTest
...
noAsmStmtsOpsTest: noAsmStmtsOps.C noAsmStmtsOpsMain.C libcompass.so $(COMPASS_PROJECT)/src/compassSupport/compassTestMain.C
	g++ -fPIC -Wall -o $@ noAsmStmtsOpsMain.C noAsmStmtsOps.C -I$(COMPASS_PROJECT)/src/compassSupport -I$(ROSE_INSTALL)/include -I$(COMPASS_PROJECT)/extensions/prerequisites -I. $(LINKER_FLAGS)
