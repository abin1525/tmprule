...
all: prerequisites.h instantiate_prerequisites.h noExceptionsTest
...
noExceptionsTest: noExceptions.C noExceptionsMain.C libcompass.so $(COMPASS_PROJECT)/src/compassSupport/compassTestMain.C
	g++ -fPIC -Wall -o $@ noExceptionsMain.C noExceptions.C -I$(COMPASS_PROJECT)/src/compassSupport -I$(ROSE_INSTALL)/include -I$(COMPASS_PROJECT)/extensions/prerequisites -I. $(LINKER_FLAGS)
