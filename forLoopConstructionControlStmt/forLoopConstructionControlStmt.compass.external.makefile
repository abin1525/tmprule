...
all: prerequisites.h instantiate_prerequisites.h forLoopConstructionControlStmtTest
...
forLoopConstructionControlStmtTest: forLoopConstructionControlStmt.C forLoopConstructionControlStmtMain.C libcompass.so $(COMPASS_PROJECT)/src/compassSupport/compassTestMain.C
	g++ -fPIC -Wall -o $@ forLoopConstructionControlStmtMain.C forLoopConstructionControlStmt.C -I$(COMPASS_PROJECT)/src/compassSupport -I$(ROSE_INSTALL)/include -I$(COMPASS_PROJECT)/extensions/prerequisites -I. $(LINKER_FLAGS)
