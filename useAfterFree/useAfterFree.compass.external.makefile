...
useAfterFreeTest: useAfterFree.C useAfterFreeMain.C libcompass.so $(COMPASS_PROJECT)/src/compassSupport/compassTestMain.C
	g++ -fPIC -Wall -o $@ useAfterFreeMain.C useAfterFree.C -I$(COMPASS_PROJECT)/src/compassSupport -I$(ROSE_INSTALL)/include -I$(COMPASS_PROJECT)/extensions/prerequisites -I. $(LINKER_FLAGS)

test: useAfterFreeTest useAfterFreeTest1.C
	./useAfterFreeTest useAfterFreeTest1.C

clean:
	rm -f libcompass.so "useAfterFreeTest"
