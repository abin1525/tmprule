...
all: prerequisites.h instantiate_prerequisites.h nameAllParametersTest
...
nameAllParametersTest: nameAllParameters.C nameAllParametersMain.C libcompass.so $(COMPASS_PROJECT)/src/compassSupport/compassTestMain.C
	g++ -fPIC -Wall -o $@ nameAllParametersMain.C nameAllParameters.C -I$(COMPASS_PROJECT)/src/compassSupport -I$(ROSE_INSTALL)/include -I$(COMPASS_PROJECT)/extensions/prerequisites -I. $(LINKER_FLAGS)
