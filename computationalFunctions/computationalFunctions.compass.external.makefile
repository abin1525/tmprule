...
all: prerequisites.h instantiate_prerequisites.h computationalFunctionsTest
...
computationalFunctionsTest: computationalFunctions.C computationalFunctionsMain.C libcompass.so $(COMPASS_PROJECT)/src/compassSupport/compassTestMain.C
	g++ -fPIC -Wall -o $@ computationalFunctionsMain.C computationalFunctions.C -I$(COMPASS_PROJECT)/src/compassSupport -I$(ROSE_INSTALL)/include -I$(COMPASS_PROJECT)/extensions/prerequisites -I. $(LINKER_FLAGS)
