...
all: prerequisites.h instantiate_prerequisites.h variableNameEqualsDatabaseNameTest
...
variableNameEqualsDatabaseNameTest: variableNameEqualsDatabaseName.C variableNameEqualsDatabaseNameMain.C libcompass.so $(COMPASS_PROJECT)/src/compassSupport/compassTestMain.C
	g++ -fPIC -Wall -o $@ variableNameEqualsDatabaseNameMain.C variableNameEqualsDatabaseName.C -I$(COMPASS_PROJECT)/src/compassSupport -I$(ROSE_INSTALL)/include -I$(COMPASS_PROJECT)/extensions/prerequisites -I. $(LINKER_FLAGS)
