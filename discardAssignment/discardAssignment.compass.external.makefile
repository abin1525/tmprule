...
all: prerequisites.h instantiate_prerequisites.h discardAssignmentTest
...
discardAssignmentTest: discardAssignment.C discardAssignmentMain.C libcompass.so $(COMPASS_PROJECT)/src/compassSupport/compassTestMain.C
	g++ -fPIC -Wall -o $@ discardAssignmentMain.C discardAssignment.C -I$(COMPASS_PROJECT)/src/compassSupport -I$(ROSE_INSTALL)/include -I$(COMPASS_PROJECT)/extensions/prerequisites -I. $(LINKER_FLAGS)
