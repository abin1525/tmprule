...
all: prerequisites.h instantiate_prerequisites.h emptyInsteadOfSizeTest
...
emptyInsteadOfSizeTest: emptyInsteadOfSize.C emptyInsteadOfSizeMain.C libcompass.so $(COMPASS_PROJECT)/src/compassSupport/compassTestMain.C
	g++ -fPIC -Wall -o $@ emptyInsteadOfSizeMain.C emptyInsteadOfSize.C -I$(COMPASS_PROJECT)/src/compassSupport -I$(ROSE_INSTALL)/include -I$(COMPASS_PROJECT)/extensions/prerequisites -I. $(LINKER_FLAGS)
