...
all: prerequisites.h instantiate_prerequisites.h forLoopCppIndexVariableDeclarationTest
...
forLoopCppIndexVariableDeclarationTest: forLoopCppIndexVariableDeclaration.C forLoopCppIndexVariableDeclarationMain.C libcompass.so $(COMPASS_PROJECT)/src/compassSupport/compassTestMain.C
	g++ -fPIC -Wall -o $@ forLoopCppIndexVariableDeclarationMain.C forLoopCppIndexVariableDeclaration.C -I$(COMPASS_PROJECT)/src/compassSupport -I$(ROSE_INSTALL)/include -I$(COMPASS_PROJECT)/extensions/prerequisites -I. $(LINKER_FLAGS)
