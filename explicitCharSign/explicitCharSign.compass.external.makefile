...
all: prerequisites.h instantiate_prerequisites.h explicitCharSignTest
...
explicitCharSignTest: explicitCharSign.C explicitCharSignMain.C libcompass.so $(COMPASS_PROJECT)/src/compassSupport/compassTestMain.C
	g++ -fPIC -Wall -o $@ explicitCharSignMain.C explicitCharSign.C -I$(COMPASS_PROJECT)/src/compassSupport -I$(ROSE_INSTALL)/include -I$(COMPASS_PROJECT)/extensions/prerequisites -I. $(LINKER_FLAGS)
