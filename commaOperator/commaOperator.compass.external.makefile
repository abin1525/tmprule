...
all: prerequisites.h instantiate_prerequisites.h commaOperatorTest
...
commaOperatorTest: commaOperator.C commaOperatorMain.C libcompass.so $(COMPASS_PROJECT)/src/compassSupport/compassTestMain.C
	g++ -fPIC -Wall -o $@ commaOperatorMain.C commaOperator.C -I$(COMPASS_PROJECT)/src/compassSupport -I$(ROSE_INSTALL)/include -I$(COMPASS_PROJECT)/extensions/prerequisites -I. $(LINKER_FLAGS)
