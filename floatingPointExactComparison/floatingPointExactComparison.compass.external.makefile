...
all: prerequisites.h instantiate_prerequisites.h floatingPointExactComparisonTest
...
floatingPointExactComparisonTest: floatingPointExactComparison.C floatingPointExactComparisonMain.C libcompass.so $(COMPASS_PROJECT)/src/compassSupport/compassTestMain.C
	g++ -fPIC -Wall -o $@ floatingPointExactComparisonMain.C floatingPointExactComparison.C -I$(COMPASS_PROJECT)/src/compassSupport -I$(ROSE_INSTALL)/include -I$(COMPASS_PROJECT)/extensions/prerequisites -I. $(LINKER_FLAGS)
