...
all: prerequisites.h instantiate_prerequisites.h doNotUseCstyleCastsTest
...
doNotUseCstyleCastsTest: doNotUseCstyleCasts.C doNotUseCstyleCastsMain.C libcompass.so $(COMPASS_PROJECT)/src/compassSupport/compassTestMain.C
	g++ -fPIC -Wall -o $@ doNotUseCstyleCastsMain.C doNotUseCstyleCasts.C -I$(COMPASS_PROJECT)/src/compassSupport -I$(ROSE_INSTALL)/include -I$(COMPASS_PROJECT)/extensions/prerequisites -I. $(LINKER_FLAGS)
