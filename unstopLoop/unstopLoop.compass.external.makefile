...
unstopLoopTest: unstopLoop.C unstopLoopMain.C libcompass.so $(COMPASS_PROJECT)/src/compassSupport/compassTestMain.C
	g++ -fPIC -Wall -o $@ unstopLoopMain.C unstopLoop.C -I$(COMPASS_PROJECT)/src/compassSupport -I$(ROSE_INSTALL)/include -I$(COMPASS_PROJECT)/extensions/prerequisites -I. $(LINKER_FLAGS)

test: unstopLoopTest unstopLoopTest1.C
	./unstopLoopTest unstopLoopTest1.C

clean:
	rm -f libcompass.so "unstopLoopTest"
