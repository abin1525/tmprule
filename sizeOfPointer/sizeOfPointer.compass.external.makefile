...
all: prerequisites.h instantiate_prerequisites.h sizeOfPointerTest
...
sizeOfPointerTest: sizeOfPointer.C sizeOfPointerMain.C libcompass.so $(COMPASS_PROJECT)/src/compassSupport/compassTestMain.C
	g++ -fPIC -Wall -o $@ sizeOfPointerMain.C sizeOfPointer.C -I$(COMPASS_PROJECT)/src/compassSupport -I$(ROSE_INSTALL)/include -I$(COMPASS_PROJECT)/extensions/prerequisites -I. $(LINKER_FLAGS)
