...
all: prerequisites.h instantiate_prerequisites.h nonAssociativeRelationalOperatorsTest
...
nonAssociativeRelationalOperatorsTest: nonAssociativeRelationalOperators.C nonAssociativeRelationalOperatorsMain.C libcompass.so $(COMPASS_PROJECT)/src/compassSupport/compassTestMain.C
	g++ -fPIC -Wall -o $@ nonAssociativeRelationalOperatorsMain.C nonAssociativeRelationalOperators.C -I$(COMPASS_PROJECT)/src/compassSupport -I$(ROSE_INSTALL)/include -I$(COMPASS_PROJECT)/extensions/prerequisites -I. $(LINKER_FLAGS)
