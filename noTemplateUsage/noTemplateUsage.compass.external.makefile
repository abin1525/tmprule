...
all: prerequisites.h instantiate_prerequisites.h noTemplateUsageTest
...
noTemplateUsageTest: noTemplateUsage.C noTemplateUsageMain.C libcompass.so $(COMPASS_PROJECT)/src/compassSupport/compassTestMain.C
	g++ -fPIC -Wall -o $@ noTemplateUsageMain.C noTemplateUsage.C -I$(COMPASS_PROJECT)/src/compassSupport -I$(ROSE_INSTALL)/include -I$(COMPASS_PROJECT)/extensions/prerequisites -I. $(LINKER_FLAGS)
