...
all: prerequisites.h instantiate_prerequisites.h byteByByteStructureComparisonTest
...
byteByByteStructureComparisonTest: byteByByteStructureComparison.C byteByByteStructureComparisonMain.C libcompass.so $(COMPASS_PROJECT)/src/compassSupport/compassTestMain.C
	g++ -fPIC -Wall -o $@ byteByByteStructureComparisonMain.C byteByByteStructureComparison.C -I$(COMPASS_PROJECT)/src/compassSupport -I$(ROSE_INSTALL)/include -I$(COMPASS_PROJECT)/extensions/prerequisites -I. $(LINKER_FLAGS)
