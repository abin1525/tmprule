...
all: prerequisites.h instantiate_prerequisites.h avoidUsingTheSameHandlerForMultipleSignalsTest
...
avoidUsingTheSameHandlerForMultipleSignalsTest: avoidUsingTheSameHandlerForMultipleSignals.C avoidUsingTheSameHandlerForMultipleSignalsMain.C libcompass.so $(COMPASS_PROJECT)/src/compassSupport/compassTestMain.C
	g++ -fPIC -Wall -o $@ avoidUsingTheSameHandlerForMultipleSignalsMain.C avoidUsingTheSameHandlerForMultipleSignals.C -I$(COMPASS_PROJECT)/src/compassSupport -I$(ROSE_INSTALL)/include -I$(COMPASS_PROJECT)/extensions/prerequisites -I. $(LINKER_FLAGS)
