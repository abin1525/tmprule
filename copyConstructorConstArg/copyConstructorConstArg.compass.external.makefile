...
all: prerequisites.h instantiate_prerequisites.h copyConstructorConstArgTest
...
copyConstructorConstArgTest: copyConstructorConstArg.C copyConstructorConstArgMain.C libcompass.so $(COMPASS_PROJECT)/src/compassSupport/compassTestMain.C
	g++ -fPIC -Wall -o $@ copyConstructorConstArgMain.C copyConstructorConstArg.C -I$(COMPASS_PROJECT)/src/compassSupport -I$(ROSE_INSTALL)/include -I$(COMPASS_PROJECT)/extensions/prerequisites -I. $(LINKER_FLAGS)
