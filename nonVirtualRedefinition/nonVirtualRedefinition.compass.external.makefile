...
all: prerequisites.h instantiate_prerequisites.h nonVirtualRedefinitionTest
...
nonVirtualRedefinitionTest: nonVirtualRedefinition.C nonVirtualRedefinitionMain.C libcompass.so $(COMPASS_PROJECT)/src/compassSupport/compassTestMain.C
	g++ -fPIC -Wall -o $@ nonVirtualRedefinitionMain.C nonVirtualRedefinition.C -I$(COMPASS_PROJECT)/src/compassSupport -I$(ROSE_INSTALL)/include -I$(COMPASS_PROJECT)/extensions/prerequisites -I. $(LINKER_FLAGS)
