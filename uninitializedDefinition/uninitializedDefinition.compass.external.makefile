...
all: prerequisites.h instantiate_prerequisites.h uninitializedDefinitionTest
...
uninitializedDefinitionTest: uninitializedDefinition.C uninitializedDefinitionMain.C libcompass.so $(COMPASS_PROJECT)/src/compassSupport/compassTestMain.C
	g++ -fPIC -Wall -o $@ uninitializedDefinitionMain.C uninitializedDefinition.C -I$(COMPASS_PROJECT)/src/compassSupport -I$(ROSE_INSTALL)/include -I$(COMPASS_PROJECT)/extensions/prerequisites -I. $(LINKER_FLAGS)
