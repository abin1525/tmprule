...
all: prerequisites.h instantiate_prerequisites.h doNotCallPutenvWithAutoVarTest
...
doNotCallPutenvWithAutoVarTest: doNotCallPutenvWithAutoVar.C doNotCallPutenvWithAutoVarMain.C libcompass.so $(COMPASS_PROJECT)/src/compassSupport/compassTestMain.C
	g++ -fPIC -Wall -o $@ doNotCallPutenvWithAutoVarMain.C doNotCallPutenvWithAutoVar.C -I$(COMPASS_PROJECT)/src/compassSupport -I$(ROSE_INSTALL)/include -I$(COMPASS_PROJECT)/extensions/prerequisites -I. $(LINKER_FLAGS)
