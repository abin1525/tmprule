...
all: prerequisites.h instantiate_prerequisites.h enumDeclarationNamespaceClassScopeTest
...
enumDeclarationNamespaceClassScopeTest: enumDeclarationNamespaceClassScope.C enumDeclarationNamespaceClassScopeMain.C libcompass.so $(COMPASS_PROJECT)/src/compassSupport/compassTestMain.C
	g++ -fPIC -Wall -o $@ enumDeclarationNamespaceClassScopeMain.C enumDeclarationNamespaceClassScope.C -I$(COMPASS_PROJECT)/src/compassSupport -I$(ROSE_INSTALL)/include -I$(COMPASS_PROJECT)/extensions/prerequisites -I. $(LINKER_FLAGS)
