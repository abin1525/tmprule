...
all: prerequisites.h instantiate_prerequisites.h noExitInMpiCodeTest
...
noExitInMpiCodeTest: noExitInMpiCode.C noExitInMpiCodeMain.C libcompass.so $(COMPASS_PROJECT)/src/compassSupport/compassTestMain.C
	g++ -fPIC -Wall -o $@ noExitInMpiCodeMain.C noExitInMpiCode.C -I$(COMPASS_PROJECT)/src/compassSupport -I$(ROSE_INSTALL)/include -I$(COMPASS_PROJECT)/extensions/prerequisites -I. $(LINKER_FLAGS)
