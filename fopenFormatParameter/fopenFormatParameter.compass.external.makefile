...
all: prerequisites.h instantiate_prerequisites.h fopenFormatParameterTest
...
fopenFormatParameterTest: fopenFormatParameter.C fopenFormatParameterMain.C libcompass.so $(COMPASS_PROJECT)/src/compassSupport/compassTestMain.C
	g++ -fPIC -Wall -o $@ fopenFormatParameterMain.C fopenFormatParameter.C -I$(COMPASS_PROJECT)/src/compassSupport -I$(ROSE_INSTALL)/include -I$(COMPASS_PROJECT)/extensions/prerequisites -I. $(LINKER_FLAGS)
