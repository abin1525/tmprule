...
all: prerequisites.h instantiate_prerequisites.h upperRangeLimitTest
...
upperRangeLimitTest: upperRangeLimit.C upperRangeLimitMain.C libcompass.so $(COMPASS_PROJECT)/src/compassSupport/compassTestMain.C
	g++ -fPIC -Wall -o $@ upperRangeLimitMain.C upperRangeLimit.C -I$(COMPASS_PROJECT)/src/compassSupport -I$(ROSE_INSTALL)/include -I$(COMPASS_PROJECT)/extensions/prerequisites -I. $(LINKER_FLAGS)
