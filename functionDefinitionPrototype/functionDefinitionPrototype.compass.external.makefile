...
all: prerequisites.h instantiate_prerequisites.h functionDefinitionPrototypeTest
...
functionDefinitionPrototypeTest: functionDefinitionPrototype.C functionDefinitionPrototypeMain.C libcompass.so $(COMPASS_PROJECT)/src/compassSupport/compassTestMain.C
	g++ -fPIC -Wall -o $@ functionDefinitionPrototypeMain.C functionDefinitionPrototype.C -I$(COMPASS_PROJECT)/src/compassSupport -I$(ROSE_INSTALL)/include -I$(COMPASS_PROJECT)/extensions/prerequisites -I. $(LINKER_FLAGS)
