...
all: prerequisites.h instantiate_prerequisites.h fileReadOnlyAccessTest
...
fileReadOnlyAccessTest: fileReadOnlyAccess.C fileReadOnlyAccessMain.C libcompass.so $(COMPASS_PROJECT)/src/compassSupport/compassTestMain.C
	g++ -fPIC -Wall -o $@ fileReadOnlyAccessMain.C fileReadOnlyAccess.C -I$(COMPASS_PROJECT)/src/compassSupport -I$(ROSE_INSTALL)/include -I$(COMPASS_PROJECT)/extensions/prerequisites -I. $(LINKER_FLAGS)
