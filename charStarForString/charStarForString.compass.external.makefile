...
all: prerequisites.h instantiate_prerequisites.h charStarForStringTest
...
charStarForStringTest: charStarForString.C charStarForStringMain.C libcompass.so $(COMPASS_PROJECT)/src/compassSupport/compassTestMain.C
	g++ -fPIC -Wall -o $@ charStarForStringMain.C charStarForString.C -I$(COMPASS_PROJECT)/src/compassSupport -I$(ROSE_INSTALL)/include -I$(COMPASS_PROJECT)/extensions/prerequisites -I. $(LINKER_FLAGS)
