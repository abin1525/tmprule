...
all: prerequisites.h instantiate_prerequisites.h localizedVariablesTest
...
localizedVariablesTest: localizedVariables.C localizedVariablesMain.C libcompass.so $(COMPASS_PROJECT)/src/compassSupport/compassTestMain.C
	g++ -fPIC -Wall -o $@ localizedVariablesMain.C localizedVariables.C -I$(COMPASS_PROJECT)/src/compassSupport -I$(ROSE_INSTALL)/include -I$(COMPASS_PROJECT)/extensions/prerequisites -I. $(LINKER_FLAGS)
