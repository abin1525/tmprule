...
pointerDepthTest: pointerDepth.C pointerDepthMain.C libcompass.so $(COMPASS_PROJECT)/src/compassSupport/compassTestMain.C
	g++ -fPIC -Wall -o $@ pointerDepthMain.C pointerDepth.C -I$(COMPASS_PROJECT)/src/compassSupport -I$(ROSE_INSTALL)/include -I$(COMPASS_PROJECT)/extensions/prerequisites -I. $(LINKER_FLAGS)

test: pointerDepthTest pointerDepthTest1.C
	./pointerDepthTest pointerDepthTest1.C

clean:
	rm -f libcompass.so "pointerDepthTest"
