...
all: prerequisites.h instantiate_prerequisites.h binPrintAsmFunctionsTest
...
binPrintAsmFunctionsTest: binPrintAsmFunctions.C binPrintAsmFunctionsMain.C libcompass.so $(COMPASS_PROJECT)/src/compassSupport/compassTestMain.C
	g++ -fPIC -Wall -o $@ binPrintAsmFunctionsMain.C binPrintAsmFunctions.C -I$(COMPASS_PROJECT)/src/compassSupport -I$(ROSE_INSTALL)/include -I$(COMPASS_PROJECT)/extensions/prerequisites -I. $(LINKER_FLAGS)
