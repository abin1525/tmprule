...
all: prerequisites.h instantiate_prerequisites.h functionDocumentationTest
...
functionDocumentationTest: functionDocumentation.C functionDocumentationMain.C libcompass.so $(COMPASS_PROJECT)/src/compassSupport/compassTestMain.C
	g++ -fPIC -Wall -o $@ functionDocumentationMain.C functionDocumentation.C -I$(COMPASS_PROJECT)/src/compassSupport -I$(ROSE_INSTALL)/include -I$(COMPASS_PROJECT)/extensions/prerequisites -I. $(LINKER_FLAGS)
