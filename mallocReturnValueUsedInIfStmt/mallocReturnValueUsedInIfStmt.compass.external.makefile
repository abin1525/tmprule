...
all: prerequisites.h instantiate_prerequisites.h mallocReturnValueUsedInIfStmtTest
...
mallocReturnValueUsedInIfStmtTest: mallocReturnValueUsedInIfStmt.C mallocReturnValueUsedInIfStmtMain.C libcompass.so $(COMPASS_PROJECT)/src/compassSupport/compassTestMain.C
	g++ -fPIC -Wall -o $@ mallocReturnValueUsedInIfStmtMain.C mallocReturnValueUsedInIfStmt.C -I$(COMPASS_PROJECT)/src/compassSupport -I$(ROSE_INSTALL)/include -I$(COMPASS_PROJECT)/extensions/prerequisites -I. $(LINKER_FLAGS)
