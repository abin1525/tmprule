...
all: prerequisites.h instantiate_prerequisites.h allowedFunctionsTest
...
allowedFunctionsTest: allowedFunctions.C allowedFunctionsMain.C libcompass.so $(COMPASS_PROJECT)/src/compassSupport/compassTestMain.C
