...
all: prerequisites.h instantiate_prerequisites.h binPrintAsmInstructionTest
...
binPrintAsmInstructionTest: binPrintAsmInstruction.C binPrintAsmInstructionMain.C libcompass.so $(COMPASS_PROJECT)/src/compassSupport/compassTestMain.C
	g++ -fPIC -Wall -o $@ binPrintAsmInstructionMain.C binPrintAsmInstruction.C -I$(COMPASS_PROJECT)/src/compassSupport -I$(ROSE_INSTALL)/include -I$(COMPASS_PROJECT)/extensions/prerequisites -I. $(LINKER_FLAGS)
