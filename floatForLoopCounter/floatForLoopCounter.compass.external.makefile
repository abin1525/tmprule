...
all: prerequisites.h instantiate_prerequisites.h floatForLoopCounterTest
...
floatForLoopCounterTest: floatForLoopCounter.C floatForLoopCounterMain.C libcompass.so $(COMPASS_PROJECT)/src/compassSupport/compassTestMain.C
	g++ -fPIC -Wall -o $@ floatForLoopCounterMain.C floatForLoopCounter.C -I$(COMPASS_PROJECT)/src/compassSupport -I$(ROSE_INSTALL)/include -I$(COMPASS_PROJECT)/extensions/prerequisites -I. $(LINKER_FLAGS)
