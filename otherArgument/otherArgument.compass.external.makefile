...
all: prerequisites.h instantiate_prerequisites.h otherArgumentTest
...
otherArgumentTest: otherArgument.C otherArgumentMain.C libcompass.so $(COMPASS_PROJECT)/src/compassSupport/compassTestMain.C
	g++ -fPIC -Wall -o $@ otherArgumentMain.C otherArgument.C -I$(COMPASS_PROJECT)/src/compassSupport -I$(ROSE_INSTALL)/include -I$(COMPASS_PROJECT)/extensions/prerequisites -I. $(LINKER_FLAGS)
