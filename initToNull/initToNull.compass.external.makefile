...
initToNullTest: initToNull.C initToNullMain.C libcompass.so $(COMPASS_PROJECT)/src/compassSupport/compassTestMain.C
	g++ -fPIC -Wall -o $@ initToNullMain.C initToNull.C -I$(COMPASS_PROJECT)/src/compassSupport -I$(ROSE_INSTALL)/include -I$(COMPASS_PROJECT)/extensions/prerequisites -I. $(LINKER_FLAGS)

test: initToNullTest initToNullTest1.C
	./initToNullTest initToNullTest1.C

clean:
	rm -f libcompass.so "initToNullTest"
