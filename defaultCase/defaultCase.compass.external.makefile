...
all: prerequisites.h instantiate_prerequisites.h defaultCaseTest
...
defaultCaseTest: defaultCase.C defaultCaseMain.C libcompass.so $(COMPASS_PROJECT)/src/compassSupport/compassTestMain.C
	g++ -fPIC -Wall -o $@ defaultCaseMain.C defaultCase.C -I$(COMPASS_PROJECT)/src/compassSupport -I$(ROSE_INSTALL)/include -I$(COMPASS_PROJECT)/extensions/prerequisites -I. $(LINKER_FLAGS)
