...
all: prerequisites.h instantiate_prerequisites.h newDeleteTest
...
newDeleteTest: newDelete.C newDeleteMain.C libcompass.so $(COMPASS_PROJECT)/src/compassSupport/compassTestMain.C
	g++ -fPIC -Wall -o $@ newDeleteMain.C newDelete.C -I$(COMPASS_PROJECT)/src/compassSupport -I$(ROSE_INSTALL)/include -I$(COMPASS_PROJECT)/extensions/prerequisites -I. $(LINKER_FLAGS)
